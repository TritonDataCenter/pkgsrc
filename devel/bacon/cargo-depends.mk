# $NetBSD: cargo-depends.mk,v 1.38 2026/09/05 20:08:37 pin Exp $
...
CARGO_CRATE_DEPENDS+=	gix-0.87.0
...
CARGO_CRATE_DEPENDS+=	gix-diff-0.67.0
...
CARGO_CRATE_DEPENDS+=	gix-note-0.1.0
CARGO_CRATE_DEPENDS+=	gix-object-0.64.1
CARGO_CRATE_DEPENDS+=	gix-odb-0.84.0
CARGO_CRATE_DEPENDS+=	gix-pack-0.74.1
CARGO_CRATE_DEPENDS+=	gix-packetline-0.22.1
CARGO_CRATE_DEPENDS+=	gix-path-0.12.5
CARGO_CRATE_DEPENDS+=	gix-pathspec-0.20.0
CARGO_CRATE_DEPENDS+=	gix-protocol-0.65.0
CARGO_CRATE_DEPENDS+=	gix-quote-0.8.0
CARGO_CRATE_DEPENDS+=	gix-ref-0.67.1
CARGO_CRATE_DEPENDS+=	gix-refspec-0.45.0
CARGO_CRATE_DEPENDS+=	gix-revision-0.49.0
...
CARGO_CRATE_DEPENDS+=	gix-transport-0.59.0
...
CARGO_CRATE_DEPENDS+=	gix-worktree-stream-0.36.0
...
CARGO_CRATE_DEPENDS+=	termimad-0.35.2
