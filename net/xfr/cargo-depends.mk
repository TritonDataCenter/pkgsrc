# $NetBSD: cargo-depends.mk,v 1.18 2026/09/06 14:00:04 pin Exp $
...
CARGO_CRATE_DEPENDS+=	mdns-sd-0.21.1
...
CARGO_CRATE_DEPENDS+=	rcgen-0.14.10
...
CARGO_CRATE_DEPENDS+=	socket-pktinfo-0.4.1
...
CARGO_CRATE_DEPENDS+=	tinyvec-1.13.2
