...
CARGO_CRATE_DEPENDS+=	auto_enums-0.8.10
...
CARGO_CRATE_DEPENDS+=	commafeed_api-0.5.0
...
CARGO_CRATE_DEPENDS+=	crc-any-3.0.1
...
CARGO_CRATE_DEPENDS+=	debug-helper-0.3.14
...
CARGO_CRATE_DEPENDS+=	derive_utils-0.16.0
CARGO_CRATE_DEPENDS+=	des-0.9.0
CARGO_CRATE_DEPENDS+=	diesel-2.3.12
CARGO_CRATE_DEPENDS+=	diesel_derives-2.3.9
...
CARGO_CRATE_DEPENDS+=	feed-rs-2.4.0
CARGO_CRATE_DEPENDS+=	feedbin_api-0.5.2
...
CARGO_CRATE_DEPENDS+=	htmd-0.5.5
...
CARGO_CRATE_DEPENDS+=	kuchikikiki-0.12.0
...
CARGO_CRATE_DEPENDS+=	libxml-0.3.21
...
CARGO_CRATE_DEPENDS+=	magic-crypt-5.0.1
...
CARGO_CRATE_DEPENDS+=	obfstr-0.4.6
...
CARGO_CRATE_DEPENDS+=	ratatui-textarea-0.9.2
...
CARGO_CRATE_DEPENDS+=	throbber-widgets-tui-0.11.1
CARGO_CRATE_DEPENDS+=	tiff-0.11.3
CARGO_CRATE_DEPENDS+=	tiger-0.3.0
...
CARGO_CRATE_DEPENDS+=	tui-logger-0.18.3
CARGO_CRATE_DEPENDS+=	tui-markdown-0.3.9
CARGO_CRATE_DEPENDS+=	tui-prompts-0.6.7
CARGO_CRATE_DEPENDS+=	tui-tree-widget-0.24.1
