# $NetBSD: cargo-depends.mk,v 1.18 2026/09/06 13:57:07 pin Exp $
...
CARGO_CRATE_DEPENDS+=	chumsky-0.10.1
...
CARGO_CRATE_DEPENDS+=	execute-0.2.15
...
CARGO_CRATE_DEPENDS+=	generic-array-1.1.0
...
CARGO_CRATE_DEPENDS+=	jxl-bitstream-1.1.0
CARGO_CRATE_DEPENDS+=	jxl-coding-1.0.1
CARGO_CRATE_DEPENDS+=	jxl-color-0.11.0
CARGO_CRATE_DEPENDS+=	jxl-frame-0.13.3
CARGO_CRATE_DEPENDS+=	jxl-grid-0.6.1
CARGO_CRATE_DEPENDS+=	jxl-image-0.13.0
CARGO_CRATE_DEPENDS+=	jxl-jbr-0.2.1
CARGO_CRATE_DEPENDS+=	jxl-modular-0.11.2
CARGO_CRATE_DEPENDS+=	jxl-oxide-0.12.5
CARGO_CRATE_DEPENDS+=	jxl-oxide-common-1.0.0
CARGO_CRATE_DEPENDS+=	jxl-render-0.12.3
CARGO_CRATE_DEPENDS+=	jxl-threadpool-1.0.0
CARGO_CRATE_DEPENDS+=	jxl-vardct-0.11.1
...
CARGO_CRATE_DEPENDS+=	material-colors-0.4.2
