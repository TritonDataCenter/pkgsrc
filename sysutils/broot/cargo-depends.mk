# $NetBSD: cargo-depends.mk,v 1.113 2026/09/06 14:02:04 pin Exp $
...
CARGO_CRATE_DEPENDS+=	cli-log-2.1.1
...
CARGO_CRATE_DEPENDS+=	deser-hjson-2.2.6
...
CARGO_CRATE_DEPENDS+=	glassbench-0.5.0
...
CARGO_CRATE_DEPENDS+=	io-kit-sys-0.5.0
...
CARGO_CRATE_DEPENDS+=	jpeg-encoder-0.5.1
...
CARGO_CRATE_DEPENDS+=	lfs-core-0.20.0
...
CARGO_CRATE_DEPENDS+=	proc-status-0.2.0
...
CARGO_CRATE_DEPENDS+=	syntect-no-panic-6.0.0
CARGO_CRATE_DEPENDS+=	tap-1.0.1
CARGO_CRATE_DEPENDS+=	tempfile-3.27.0
CARGO_CRATE_DEPENDS+=	termimad-0.35.3
CARGO_CRATE_DEPENDS+=	terminal-clipboard-0.4.1
CARGO_CRATE_DEPENDS+=	terminal-light-1.9.1
...
CARGO_CRATE_DEPENDS+=	xterm-query-0.6.1
...
CARGO_CRATE_DEPENDS+=	zune-bmp-0.4.0
CARGO_CRATE_DEPENDS+=	zune-core-0.4.12
CARGO_CRATE_DEPENDS+=	zune-core-0.5.3
CARGO_CRATE_DEPENDS+=	zune-farbfeld-0.4.0
CARGO_CRATE_DEPENDS+=	zune-hdr-0.4.0
CARGO_CRATE_DEPENDS+=	zune-image-0.4.15
...
CARGO_CRATE_DEPENDS+=	zune-ppm-0.4.0
CARGO_CRATE_DEPENDS+=	zune-psd-0.4.0
CARGO_CRATE_DEPENDS+=	zune-qoi-0.4.10
