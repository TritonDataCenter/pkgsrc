# $NetBSD: cargo-depends.mk,v 1.7 2026/09/06 13:58:06 pin Exp $
...
CARGO_CRATE_DEPENDS+=	io-gmail-0.3.0
CARGO_CRATE_DEPENDS+=	io-http-0.5.0
CARGO_CRATE_DEPENDS+=	io-imap-0.5.0
CARGO_CRATE_DEPENDS+=	io-jmap-0.3.0
CARGO_CRATE_DEPENDS+=	io-m2dir-0.2.1
CARGO_CRATE_DEPENDS+=	io-maildir-0.3.0
CARGO_CRATE_DEPENDS+=	io-msgraph-0.3.0
CARGO_CRATE_DEPENDS+=	io-pim-discovery-0.7.0
CARGO_CRATE_DEPENDS+=	io-pimdir-0.2.0
CARGO_CRATE_DEPENDS+=	io-proxy-0.1.0
CARGO_CRATE_DEPENDS+=	io-replica-0.3.0
CARGO_CRATE_DEPENDS+=	io-sasl-0.1.0
CARGO_CRATE_DEPENDS+=	io-smtp-0.3.0
...
CARGO_CRATE_DEPENDS+=	mail-parser-0.11.6
...
CARGO_CRATE_DEPENDS+=	pimalaya-cli-0.2.2
CARGO_CRATE_DEPENDS+=	pimalaya-config-0.1.4
CARGO_CRATE_DEPENDS+=	pimalaya-stream-0.3.0
